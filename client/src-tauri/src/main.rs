...
fn render_email(company_name: &str, config: &AppConfig) -> EmailPreview {
    ...
    let html = format!(
        r#"<div style="margin:0;padding:0;background:#f5f7fa;color:#1f2933;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Microsoft YaHei',Arial,sans-serif;">
  <div style="max-width:640px;margin:0 auto;padding:24px 12px;">
    <div style="background:#ffffff;border:1px solid #e1e7ef;border-radius:10px;overflow:hidden;">
      <div style="padding:20px 24px;background:#f8fafc;border-bottom:1px solid #e1e7ef;">
        ...
        <div style="margin-top:4px;font-size:20px;line-height:1.35;font-weight:700;color:#102a43;">{company_html}，您好</div>
      </div>
      <div style="padding:24px;font-size:15px;line-height:1.85;color:#243b53;">
        <p style="margin:0 0 14px;">我方为{branch_html}。</p>
        ...
        <p style="margin:0 0 18px;">这类事项建议转给融资或财务相关同事推进。有需要可以随时联系我行客户经理{manager_html}{phone_html}。</p>
        <div style="margin-top:22px;padding-top:16px;border-top:1px solid #e1e7ef;color:#334e68;">
          <div style="margin-bottom:6px;">{branch_html}行长 {president_html}</div>
